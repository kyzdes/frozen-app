...
- ✅ Выбор иконок (30+ эмодзи) или вариант без эмодзи
...
- ✅ История изменений (создание, изменение количества) с сортировкой/фильтром по дате, экспортируется вместе с данными
...
**Технологии:**
- SwiftUI (iOS 16+)
- NSUbiquitousKeyValueStore + UserDefaults fallback для хранения
