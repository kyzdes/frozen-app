// icons.tsx — Lucide-path inline SVG icon set for the Arctic Frost web app.
// Reproduces the product's real Lucide icons as inline SVG (2px stroke, 24-grid,
// rounded caps/joins) so they survive React re-renders without a CDN dependency.
...
const PATHS = {
  ...
  alertTri: '<path d="m21.73 18-8-14a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/>',
